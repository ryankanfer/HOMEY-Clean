                ...
                VStack(alignment: .leading, spacing: 16) {
                    HStack(alignment: .center, spacing: 12) {
                        ...
                        RoundedRectangle(cornerRadius: 22, style: .continuous)
                            ...
                            .overlay(Image(systemName: "person.crop.square").symbolRenderingMode(.hierarchical)
                                .font(.system(size: 44)).foregroundStyle(.secondary.opacity(0.6))
                            )
                            .frame(width: 96, height: 96)
                    }

                    ReadinessBar(progress: readiness)
                    ...
                    TipsBanner(title: "Tidy Tips", subtitle: "Board Interview Checklist", buttonTitle: "View") {}
                        .padding(.top, 4)
                }
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            ZStack(alignment: .leading) {
                ...
                .frame(width: max(8, progress.clamped(to: 0 ... 1) * 1000), height: 12)
...
private struct ChecklistCards: View {
    ...
    private func icon(for s: DocState) -> String {
        switch s {
        case .done: return "checkmark.circle.fill"; case .pending: return "clock.fill"; case .missing: return "exclamationmark.circle.fill"
        }
    }

    private func color(for s: DocState) -> Color {
        switch s { case .done: return .green; case .pending: return .orange; case .missing: return .red }
    }
}
