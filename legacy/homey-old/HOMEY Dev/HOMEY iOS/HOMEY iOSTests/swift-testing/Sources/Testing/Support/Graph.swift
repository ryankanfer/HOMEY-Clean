...
extension Graph {
    ...
    func compactMapValues<
        U,
        E
    >(_ transform: (Element) throws(E) -> (U, recursivelyApply: Bool)?) throws(E) -> Graph<K, U>? {
    ...
    ///
    /// - Throws: Whatever is thrown by `transform`.
    private func _compactMapValues<U, E>(
        keyPath: [K],
        _ transform: (Element) throws(E) -> (U, recursivelyApply: Bool)?
    ) throws(E) -> Graph<K, U>? {
    ...
    func compactMapValues<
        U,
        E
    >(_ transform: (Element) async throws(E) -> (U, recursivelyApply: Bool)?) async throws(E) -> Graph<K, U>? {
    ...
    private func _compactMapValues<U, E>(
        keyPath: [K],
        _ transform: (Element) async throws(E) -> (U, recursivelyApply: Bool)?
    ) async throws(E) -> Graph<K, U>? {
