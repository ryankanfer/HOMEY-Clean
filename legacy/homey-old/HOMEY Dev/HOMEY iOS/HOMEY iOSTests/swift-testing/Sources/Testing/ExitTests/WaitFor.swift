    ...
    internal import _TestingInternals
        ...
        private func _blockAndWait(for pid: consuming pid_t) throws -> ExitCondition {
            ...
            while true {
                ...
                if waitid(P_PID, id_t(pid), &siginfo, WEXITED) == 0 {
                    ...
                    default:
                        throw SystemError(
                            description: "Unexpected siginfo_t value. Please file a bug report at https://github.com/swiftlang/swift-testing/issues/new and include this information: \(String(reflecting: siginfo))"
                        )
                    }
        ...
        private let _createWaitThread: Void = {
            ...
            func waitForAnyChild() {
                ...
                var siginfo = siginfo_t()
                if waitid(P_ALL, 0, &siginfo, WEXITED | WNOWAIT) == 0 {
        ...
        func wait(for pid: consuming pid_t) async throws -> ExitCondition {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                _childProcessContinuations.withLock { childProcessContinuations in
                    ...
                    assert(
                        oldContinuation == nil,
                        "Unexpected continuation found for PID \(pid). Please file a bug report at https://github.com/swiftlang/swift-testing/issues/new"
                    )
        ...
        func wait(for processHandle: consuming HANDLE) async throws -> ExitCondition {
            ...
            try await withCheckedThrowingContinuation { (continuation: CheckedContinuation<Void, any Error>) in
                ...
                let callback: WAITORTIMERCALLBACK = { context, _ in
                    let continuation = Unmanaged<AnyObject>.fromOpaque(context!)
                        .takeRetainedValue() as! CheckedContinuation<
                            Void,
                            any Error
                        >
                    continuation.resume()
        ...
        func wait(for _: consuming Never) async throws -> ExitCondition {}
    #endif
#endif
