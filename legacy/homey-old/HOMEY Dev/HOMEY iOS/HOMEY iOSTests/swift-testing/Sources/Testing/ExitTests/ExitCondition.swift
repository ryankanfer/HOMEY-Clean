...
public enum ExitCondition: Sendable {
    ...
    ///
    /// The C programming language defines two [standard exit
    /// codes](https://en.cppreference.com/w/c/program/EXIT_status),
    /// `EXIT_SUCCESS` and `EXIT_FAILURE`. Platforms may additionally define their
    /// own non-standard exit codes:
    ///
    /// | Platform | Header |
    /// |-|-|
    /// | macOS | [`<stdlib.h>`](https://developer.apple.com/library/archive/documentation/System/Conceptual/ManPages_iPhoneOS/man3/_Exit.3.html),
    /// [`<sysexits.h>`](https://developer.apple.com/library/archive/documentation/System/Conceptual/ManPages_iPhoneOS/man3/sysexits.3.html)
    /// |
    /// | Linux | [`<stdlib.h>`](https://sourceware.org/glibc/manual/latest/html_node/Exit-Status.html), `<sysexits.h>`
    /// |
    /// | FreeBSD | [`<stdlib.h>`](https://man.freebsd.org/cgi/man.cgi?exit(3)),
    /// [`<sysexits.h>`](https://man.freebsd.org/cgi/man.cgi?sysexits(3)) |
    ...
    ///
    /// The C programming language defines a number of [standard
    /// signals](https://en.cppreference.com/w/c/program/SIG_types).
...
@_spi(Experimental)
    ...
    @available(*, unavailable, message: "Exit tests are not available on this platform.")
#endif
public extension ExitCondition? {
