    ...
    public extension Expectation {
        ...
        struct Snapshot: Sendable, Codable {
            ...
            public init(snapshotting expectation: borrowing Expectation) {
                evaluatedExpression = expectation.evaluatedExpression
                mismatchedErrorDescription = expectation.mismatchedErrorDescription ?? expectation
                    .mismatchedExitConditionDescription
                differenceDescription = expectation.differenceDescription
                isPassing = expectation.isPassing
