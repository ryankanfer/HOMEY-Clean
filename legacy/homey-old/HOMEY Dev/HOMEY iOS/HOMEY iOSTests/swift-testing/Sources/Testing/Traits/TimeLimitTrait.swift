...
public extension Trait where Self == TimeLimitTrait {
    ...
    @_spi(Experimental)
    static func timeLimit(_ timeLimit: Duration) -> Self {
    ...
    static func timeLimit(_ timeLimit: Self.Duration) -> Self {
        return Self(timeLimit: timeLimit.underlyingDuration)
    }
}

@available(_clockAPI, *)
public extension TimeLimitTrait.Duration {
    ...
    static func seconds(_: some BinaryInteger) -> Self {
    ...
    /// This function is unavailable and is provided for diagnostic purposes only.
    @available(*, unavailable, message: "Time limit must be specified in minutes")
    static func milliseconds(_: some BinaryInteger) -> Self {
        fatalError("Unsupported")
    }
    ...
    /// This function is unavailable and is provided for diagnostic purposes only.
    @available(*, unavailable, message: "Time limit must be specified in minutes")
    static func milliseconds(_: Double) -> Self {
        fatalError("Unsupported")
    }
    ...
    /// This function is unavailable and is provided for diagnostic purposes only.
    @available(*, unavailable, message: "Time limit must be specified in minutes")
    static func microseconds(_: some BinaryInteger) -> Self {
        fatalError("Unsupported")
    }
    ...
    /// This function is unavailable and is provided for diagnostic purposes only.
    @available(*, unavailable, message: "Time limit must be specified in minutes")
    static func microseconds(_: Double) -> Self {
        fatalError("Unsupported")
    }
    ...
    /// This function is unavailable and is provided for diagnostic purposes only.
    @available(*, unavailable, message: "Time limit must be specified in minutes")
    static func nanoseconds(_: some BinaryInteger) -> Self {
        fatalError("Unsupported")
    }
}
...
public extension Test {
    ...
    func adjustedTimeLimit(configuration: Configuration) -> Duration? {
