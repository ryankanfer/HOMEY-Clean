...
public extension Attachable where Self: ~Copyable {
    var estimatedAttachmentByteCount: Int? {
        nil
    }
}

public extension Attachable where Self: Collection, Element == UInt8 {
    var estimatedAttachmentByteCount: Int? {
        count
    }
...
public extension Attachable where Self: StringProtocol {
    var estimatedAttachmentByteCount: Int? {
