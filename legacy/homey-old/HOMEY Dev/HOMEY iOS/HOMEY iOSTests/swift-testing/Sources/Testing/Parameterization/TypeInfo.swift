...
public extension TypeInfo {
    ...
    internal var mangledName: String? {
...
extension TypeInfo: Codable {
    ...
    public init(from decoder: any Decoder) throws {
        ...
        self.init(
            fullyQualifiedName: encodedForm.fullyQualifiedName,
            unqualifiedName: encodedForm.unqualifiedName,
            mangledName: encodedForm.mangledName
        )
    }
}
