...
public extension Event {
    ...
    struct ConsoleOutputRecorder: Sendable /* , ~Copyable */ {
...
private extension Event.Symbol {
    ...
    ///   a stream.
    func stringValue(options: Event.ConsoleOutputRecorder.Options) -> String {
...
private extension Event.ConsoleOutputRecorder {
    ...
    func colorDots(for tags: Set<Tag>) -> String {
...
public extension Event.ConsoleOutputRecorder.Options {
