...
public extension __Expression {
    ...
    static func __fromSyntaxNode(_ syntaxNode: String) -> Self {
    ...
    /// - Warning: This function is used to implement the `@Test`, `@Suite`,
    ///   `#expect()` and `#require()` macros. Do not call it directly.
    static func __fromStringLiteral(_ sourceCode: String, _ stringValue: String) -> Self {
    ...
    /// - Warning: This function is used to implement the `@Test`, `@Suite`,
    ///   `#expect()` and `#require()` macros. Do not call it directly.
    static func __fromBinaryOperation(_ lhs: Self, _ op: String, _ rhs: Self) -> Self {
    ...
    /// - Warning: This function is used to implement the `@Test`, `@Suite`,
    ///   `#expect()` and `#require()` macros. Do not call it directly.
    static func __fromFunctionCall(
        _ value: Self?,
        _ functionName: String,
        _ arguments: (label: String?, value: Self)...
    ) -> Self {
    ...
    /// - Warning: This function is used to implement the `@Test`, `@Suite`,
    ///   `#expect()` and `#require()` macros. Do not call it directly.
    static func __fromPropertyAccess(_ value: Self, _ keyPath: Self) -> Self {
    ...
    /// - Warning: This function is used to implement the `@Test`, `@Suite`,
    ///   `#expect()` and `#require()` macros. Do not call it directly.
    static func __fromNegation(_ expression: Self, _ isParenthetical: Bool) -> Self {
