...
extension Runner {
    ...
    ///
    /// - ``Runner/run()``
    private func _runStep(
        atRootOf stepGraph: Graph<String, Plan.Step?>,
        depth: Int,
        lastAncestorStep: Plan.Step?
    ) async throws {
    ...
    private func _runChildren(
        ...
        let isParallelizationEnabled = stepOrAncestor?.action.isParallelizationEnabled ?? configuration
