...
struct Locked<T>: RawRepresentable, Sendable where T: Sendable {
    ...
    /// or `OSAllocatedUnfairLock`.
        ...
        (os(WASI) && compiler(>=6.1) && _runtime(_multithreaded))
    ...
    nonmutating func withLock<R>(_ body: (inout T) throws -> R) rethrows -> R {
        ...
        ///   effect is undefined.
        nonmutating func withUnsafeUnderlyingLock<R>(_ body: (UnsafeMutablePointer<pthread_mutex_t>, T) throws
            -> R
        ) rethrows -> R {
