...
public struct Configuration: Sendable {
    ...
    public struct RepetitionPolicy: Sendable {
        ...
        public var maximumIterationCount: Int {
            willSet {
                precondition(
                    newValue > 0,
                    "Test runs must iterate at least once (maximumIterationCount was \(newValue))."
                )
            }
        }
        ...
        public static func repeating(
            _ continuationCondition: ContinuationCondition? = nil,
    ...
    public var eventHandler: Event.Handler = { _, _ in }
        ...
        public var exitTestHandler: ExitTest.Handler = { _ in
            throw SystemError(
                description: "Exit test support has not been implemented by the current testing infrastructure."
            )
        }
    #endif
