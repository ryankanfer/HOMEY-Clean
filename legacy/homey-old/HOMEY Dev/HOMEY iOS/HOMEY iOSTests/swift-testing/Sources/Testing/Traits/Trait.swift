...
public extension Trait where Self: TestScoping {
...
public extension SuiteTrait where Self: TestScoping {
    /// Get this trait's scope provider for the specified test and optional test
    /// case.
    ///
    /// - Parameters:
...
extension Never: TestScoping {
    public func provideScope(
        ...
        performing _: @Sendable () async throws -> Void
    ) async throws {}
}
...
public extension Trait where TestScopeProvider == Never {
    /// Get this trait's scope provider for the specified test or test case.
    ///
    /// - Parameters:
    ///   - test: The test for which the testing library requests a
    ...
    func scopeProvider(for _: Test, testCase _: Test.Case?) -> Never? {
        nil
    }
}

public extension SuiteTrait {
