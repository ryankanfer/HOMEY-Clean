...
private import _TestingInternals
        ...
        private var _appDataDirectoryPath: String? {
            ...
            if S_OK == SHGetKnownFolderPath(&FOLDERID_LocalAppData, 0, nil, &appDataDirectoryPath),
               let appDataDirectoryPath
            {
                defer {
    ...
    func loadTagColors(fromFileInDirectoryAtPath swiftTestingDirectoryPath: String? = swiftTestingDirectoryPath) throws
        -> [Tag: Tag.Color]
    {
