...
//
    ...
    @_spi(Experimental)
    public extension Attachable where Self: NSSecureCoding {
        /// Encode this object using
        ...
        /// [`NSKeyedArchiver`](https://developer.apple.com/documentation/foundation/nskeyedarchiver) |
        /// | None, `".plist"` | Binary property list |
        /// [`NSKeyedArchiver`](https://developer.apple.com/documentation/foundation/nskeyedarchiver) |
        ///
        ...
        func withUnsafeBufferPointer<R>(
            ...
            case .json:
                throw CocoaError(
                    ...
                    userInfo: [
                        NSLocalizedDescriptionKey: "An instance of \(type(of: self)) cannot be encoded as JSON. Specify a property list format instead.",
                    ]
                )
            }
