    ...
    public import Foundation
        ...
        extension URL {
            ...
            fileprivate extension UTType {
                ...
                static let tgz = UTType("org.gnu.gnu-zip-tar-archive")
            }
        #endif

        @_spi(Experimental)
        public extension Attachment where AttachableValue == Data {
            ...
            init(
                ...
                guard url.isFileURL else {
                    ...
                    throw CocoaError(
                        .featureUnsupported,
                        userInfo: [NSLocalizedDescriptionKey: "Attaching downloaded files is not supported"]
                    )
                }
                ...
                if isDirectory {
                    ...
                    try await self.init(
                        Data(compressedContentsOfDirectoryAt: url),
                        named: preferredName,
            ...
            init(compressedContentsOfDirectoryAt directoryURL: URL) async throws {
                ...
                let temporaryURL = FileManager.default.temporaryDirectory.appendingPathComponent(temporaryName)
                    ...
                    throw CocoaError(
                        .featureUnsupported,
                        userInfo: [
                            NSLocalizedDescriptionKey: "This platform does not support attaching directories to tests.",
                        ]
                    )
                #endif
            }
