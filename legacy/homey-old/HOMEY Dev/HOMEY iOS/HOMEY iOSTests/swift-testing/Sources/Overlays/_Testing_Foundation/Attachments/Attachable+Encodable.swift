...
//
    ...
    ) throws -> R where E: Attachable & Encodable {
    ...
    @_spi(Experimental)
    public extension Attachable where Self: Encodable {
        /// Encode this value into a buffer using either
