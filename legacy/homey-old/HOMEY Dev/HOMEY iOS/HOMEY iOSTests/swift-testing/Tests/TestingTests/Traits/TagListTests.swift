...
struct TagListTests {
    ...
    func tagListDescription() throws {
        ...
        #expect((trait as Any) is Tag.List)
        #expect(String(describing: trait) ==
            ".namedConstant, .anotherConstant, .red, .orange, .yellow, .green, .blue, .purple"
        )
    }
    ...
    @Test(
        "Tag colors are converted to 16-color correctly",
        arguments: [
            ...
            // Dark colors
            (.rgb(100, 0, 0), 31), (.rgb(100, 100, 0), 33), (.rgb(0, 100, 0), 32), (.rgb(0, 100, 100), 36), (
                .rgb(0, 0, 100),
                34
            ), (.rgb(100, 0, 100), 35),

            // Bright colors
            (.rgb(200, 0, 0), 91), (.rgb(200, 200, 0), 93), (.rgb(0, 200, 0), 92), (.rgb(0, 200, 200), 96), (
                .rgb(0, 0, 200),
                94
            ), (.rgb(200, 0, 200), 95),
        ]
