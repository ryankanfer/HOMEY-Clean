...
struct GraphTests {
    ...
    func insert() {
        ...
        graph.insertValue(314_159, at: ["C2", "C3", "C4"])
        #expect(graph.children["C2"]?.children["C3"]?.children["C4"]?.value == 314_159)
    ...
    func insertWhereNoneExists() {
        ...
        let oldValue = graph.insertValue(314_159, at: ["C2", "C3", "C4", "C5", "C6"], intermediateValue: 9999)
        #expect(oldValue == nil)
    }
    ...
    func insertOptionalWhereNoneExists() {
        ...
        let oldValue = graph.insertValue(314_159, at: ["C2", "C3", "C4", "C5", "C6"])
        #expect(oldValue == nil)
    }
