...
struct Test_Case_ArgumentTests {
    ...
    func one1TupleParameter() async {
        ...
        await runTestFunction(
            named: "one1TupleParameter(x:)",
            in: ParameterizedTests.self,
    ...
    func DictionaryElementParameters() async {
        ...
        await runTestFunction(
            named: "twoDictionaryElementParameters(x:y:)",
            in: ParameterizedTests.self,
            configuration: configuration
        )
    }
    ...
    func oneDictionaryElementTupleParameter() async {
        ...
        await runTestFunction(
            named: "oneDictionaryElementTupleParameter(x:)",
            in: ParameterizedTests.self,
            configuration: configuration
        )
    }
...
struct ParameterizedTests {
    ...
    func oneParameter(x _: String) {}

    @Test(.hidden, arguments: ["value"], [123])
    func twoParameters(x _: String, y _: Int) {}

    @Test(.hidden, arguments: ["value"])
    func one1TupleParameter(x _: String) {}

    @Test(.hidden, arguments: [("value", 123)])
    func one2TupleParameter(x _: (String, Int)) {}

    @Test(.hidden, arguments: ["value": 123])
    func twoDictionaryElementParameters(x _: String, y _: Int) {}

    @Test(.hidden, arguments: ["value": 123])
    func oneDictionaryElementTupleParameter(x _: (key: String, value: Int)) {}

    @Test(.disabled(), arguments: [1, 2, 3]) func disabled(x _: Int) {}
}
