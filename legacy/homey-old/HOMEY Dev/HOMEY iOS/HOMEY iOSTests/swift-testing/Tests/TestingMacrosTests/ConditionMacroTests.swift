...
struct ConditionMacroTests {
    ...
    @Test(
        "Capturing comments above #expect()/#require()",
        arguments: [
            """
            // Source comment
            /** Doc comment */
    ...
    @Test(
        "#expect(false) and #require(false) warn they always fail",
    ...
    @Test(
        "#expect(true) and #require(true) note they always pass",
    ...
    @Test(
        "Bool(false) suppresses the warning about always failing",
    ...
    @Test(
        "as! warns when used with #require()",
    ...
    @Test(
        "as! warning is suppressed for explicit Bool and Optional casts",
        arguments: [
    ...
    @Test(
        "#require(Bool?) produces a diagnostic",
        arguments: [
    ...
    @Test(
        "#require(as Bool?) suppresses its diagnostic",
        arguments: [
    ...
    @Test(
        "#require(non-optional value) produces a diagnostic",
        arguments: [
    ...
    @Test(
        "#require(throws: Never.self) produces a diagnostic",
        arguments: [
