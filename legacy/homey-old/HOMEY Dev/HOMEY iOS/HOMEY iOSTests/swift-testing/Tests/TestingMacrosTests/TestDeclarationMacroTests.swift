...
struct TestDeclarationMacroTests {
    @Test(
        "Error diagnostics emitted on API misuse",
        arguments: [
                ...
                (
                    ...
                    fixIts: [
                        ExpectedFixIt(
                            ...
                            changes: [.replace(
                                oldSourceCode: "@Test ",
                                newSourceCode: "@Test(arguments: \(EditorPlaceholderExprSyntax(type: "[Int]"))) "
                            )]
                        ),
                    ]
                ),
                ...
                (
                    ...
                    fixIts: [
                        ExpectedFixIt(
                            ...
                            changes: [.replace(
                                oldSourceCode: "@Test ",
                                newSourceCode: "@Test(arguments: \(EditorPlaceholderExprSyntax(type: "[(Int, String)]"))) "
                            )]
                        ),
                        ExpectedFixIt(
                            ...
                            changes: [.replace(
                                oldSourceCode: "@Test ",
                                newSourceCode: "@Test(arguments: \(EditorPlaceholderExprSyntax(type: "[Int]")), \(EditorPlaceholderExprSyntax(type: "[String]"))) "
                            )]
                        ),
                    ]
                ),
                ...
                (
                    ...
                    fixIts: [
                        ExpectedFixIt(
                            ...
                            changes: [.replace(
                                oldSourceCode: "@Test ",
                                newSourceCode: "@Test(arguments: \(EditorPlaceholderExprSyntax(type: "[(Int, String, Double)]"))) "
                            )]
                        ),
                    ]
                ),
                ...
                (
                    ...
                    fixIts: [
                        ExpectedFixIt(
                            message: "Add 'arguments:' with one collection",
                            changes: [.replace(
                                oldSourceCode: #"@Test("Some display name") "#,
                                newSourceCode: #"@Test("Some display name", arguments: \#(EditorPlaceholderExprSyntax(type: "[Int]"))) "#
                            )]
                        ),
                    ]
                ),
                ...
                (
                    ...
                    fixIts: [
                        ExpectedFixIt(
                            message: "Add 'arguments:' with one collection",
                            changes: [.replace(
                                oldSourceCode: #"@Test /*comment*/ "#,
                                newSourceCode: #"@Test(arguments: \#(EditorPlaceholderExprSyntax(type: "[Int]"))) /*comment*/ "#
                            )]
                        ),
                    ]
                ),
    ...
    func apiMisuseErrorsIncludingFixIts(
        input: String,
        expectedDiagnostic: (message: String, fixIts: [ExpectedFixIt])
    ) throws {
        let (_, diagnostics) = try parse(input)
    ...
    @Test(
        "Warning diagnostics emitted on API misuse",
        arguments: [
            // return types
            "@Test func f() -> Int {}":
    ...
    @Test(
        "Availability attributes are captured",
        arguments: [
    ...
    @Test(
        "Valid tag expressions are allowed",
        arguments: [
            #"@Test(.tags(.f)) func f() {}"#,
    ...
    @Test(
        "Invalid tag expressions are detected",
        arguments: [
            "f()", ".f()", "loose",
    ...
    func invalidTagExpressions(tagExpr: String) throws {
        ...
        for diagnostic in diagnostics {
            ...
            #expect(diagnostic
                .message ==
                "Tag '\(tagExpr)' cannot be used with attribute 'Test'; pass a member of 'Tag' or a string literal instead"
            )
        }
    }

    @Test(
        "Valid bug identifiers are allowed",
        arguments: [
    ...
    func invalidBugURLs(id: String) throws {
        ...
        for diagnostic in diagnostics {
            #expect(diagnostic.diagMessage.severity == .warning)
            #expect(diagnostic
                .message == #"URL "\#(id)" is invalid and cannot be used with trait 'bug' in attribute 'Test'"#
            )
        }
    }
}
