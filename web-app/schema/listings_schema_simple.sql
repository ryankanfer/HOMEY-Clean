-- =====================================================
-- HOMEY Listings Database Schema (Simplified)
...
-- Authenticated users can insert/update/delete (for now - tighten later)
...
(
    ...
    TRUE, FALSE, TRUE,
    'Stunning two-bedroom apartment in the heart of Flatiron with floor-to-ceiling windows and modern finishes.',
    'Sarah Johnson', '(555) 123-4567', 'sarah@flatironliving.com', 'Flatiron Living Realty'
),
(
    ...
    4, 'quiet', 92, 75, 9.0,
    FALSE, TRUE, FALSE,
    'Charming one-bedroom in the heart of West Village with a private outdoor patio.',
    'Michael Chen', '(555) 987-6543', 'mchen@villageproperties.com', 'West Village Properties'
),
(
    ...
    TRUE, TRUE, TRUE,
    'Spectacular Tribeca loft with soaring 14-foot ceilings and massive windows.',
    'Emma Rodriguez', '(555) 456-7890', 'emma@tribecaluxury.com', 'Tribeca Luxury Living'
),
(
    ...
    5, 'quiet', 85, 90, 8.0,
    TRUE, FALSE, FALSE,
    'Cozy studio in pre-war Gramercy building with excellent natural light.',
    'David Park', '(555) 234-5678', 'dpark@gramercyproperties.com', 'Gramercy Properties'
),
(
    ...
    7, 'busy', 88, 95, 7.5,
    FALSE, FALSE, TRUE,
    'Luxurious two-bedroom condo with stunning city views and world-class amenities.',
